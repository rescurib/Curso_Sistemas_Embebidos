...
```
>[!NOTE]
> Puedes usar la consola UCRT64, pero si quieres usar el GNU toolchain desde CMD, debes añadir a la variable de entorno de sistema PATH este directorio: C:\msys64\ucrt64\bin y por debajo de, ese añadir este otro: C:\msys64\usr\bin\
