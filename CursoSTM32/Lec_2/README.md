...
* **Práctica 2.3: Técnicas anti-rebote** Lo importante en esta práctica será hablar de las implementaciones basadas en programación orientada a objetos en C y técnicas para mitigar el ruido de lectura en los botones.
