...
<p>
  ...
  Si ya has desarrollado otros tipos de software seguramente conoces Git. Si no es así, es importante que te familiarices con esta herramienta. [Aquí](https://www.youtube.com/playlist?list=PLdX95r_5VhojrYffoY3OEySCW4RlEtaMG) hay un curso en español de Git desde terminal y con Sourcetree. Puedes practicar creando repos de tus prácticas de microcontroladores y subir o corregir tus cambios con Sourcetree. Uno de los mejores libros sobre Git es [*Pro Git* de Scott Chacon](https://git-scm.com/book/en/v2) ¡y es gratis!
